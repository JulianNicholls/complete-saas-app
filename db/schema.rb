...
ActiveRecord::Schema.define(version: 20151216110209) do
  ...
  add_index "artefacts", ["project_id"], name: "index_artefacts_on_project_id", using: :btree
  ...
  add_foreign_key "artefacts", "projects"
